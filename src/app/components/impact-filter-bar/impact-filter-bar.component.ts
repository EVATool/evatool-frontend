...
export class ImpactFilterBarComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.stakeholderDataService.loadedStakeholders.pipe(takeUntil(this.ngUnsubscribe)).subscribe((stakeholders: Stakeholder[]) => {
      this.updateStakeholders();
    });

    this.stakeholderDataService.createdStakeholder.pipe(takeUntil(this.ngUnsubscribe)).subscribe((stakeholder: Stakeholder) => {
      this.updateStakeholders();
    });

    this.stakeholderDataService.updatedStakeholder.pipe(takeUntil(this.ngUnsubscribe)).subscribe((stakeholder: Stakeholder) => {
      this.updateStakeholders();
    });

    this.stakeholderDataService.deletedStakeholder.pipe(takeUntil(this.ngUnsubscribe)).subscribe((stakeholder: Stakeholder) => {
      this.updateStakeholders();
    });
    ...
    this.valueDataService.updatedValue.pipe(takeUntil(this.ngUnsubscribe)).subscribe((value: Value) => {
      this.updateValues();
    });
